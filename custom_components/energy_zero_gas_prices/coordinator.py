...
class EnergyZeroCoordinator(DataUpdateCoordinator):
    ...
    async def _async_update_data(self) -> dict:
        """Get the latest data from Energy Zero"""
        self.logger.debug("Fetching Energy Zero data")
