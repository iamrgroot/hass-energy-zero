"""Config flow for Energy Zero gas prices integration."""
...
class EasyEnergyFlowHandler(ConfigFlow, domain=DOMAIN):
    """Handle a config flow for Easy Energy gas prices."""
    ...
    ) -> EasyEnergyOptionFlowHandler:
        """Get the options flow for this handler."""
        return EasyEnergyOptionFlowHandler(config_entry)
...
class EasyEnergyOptionFlowHandler(OptionsFlow):
    """Handle options."""
